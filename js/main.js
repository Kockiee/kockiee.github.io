...
function download2(){
    window.open("https://github.com/Kockiee/Kockie-Optimizer-C-Sharp/releases/download/V-1.4.2/Kockie.Optimizer.-.x64.64bit.zip");
}
function download3(){
    window.open("https://github.com/Kockiee/Kockie-Optimizer-C-Sharp/releases/download/V-1.4.2/Kockie.Optimizer.-.x84.32bit.zip");
}
